...
#include "std_msgs/msg/string.hpp"  // Standard message type for stings
...
public:
    ...
    void timerCallback()
    {
        ...
        message.data = "Hello Worlds! " + std::to_string(count_++);
...
private:
    ...
    rclcpp::TimerBase::SharedPtr timer_; // Instance timer
